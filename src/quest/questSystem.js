...
export const QUEST_DATA = {
  ...
  main_01: {
    ...
    objectives: [{ type: "talk", target: "elder", count: 1, current: 0 }],
  ...
  main_04: {
    ...
    objectives: [{ type: "kill", target: "skeleton", count: 3, current: 0 }],
  ...
  main_05: {
    ...
    objectives: [{ type: "talk", target: "king", count: 1, current: 0 }],
  ...
  main_final: {
    ...
    objectives: [{ type: "kill", target: "demon_lord", count: 1, current: 0 }],
  ...
  side_mushroom: {
    ...
    description: "收集5个蘑菇。",
    giver: "villager1",
    objectives: [{ type: "collect", target: "mushroom", count: 5, current: 0 }],
  ...
  side_fishing: {
    ...
    giver: "fisher",
    objectives: [{ type: "fish", count: 3, current: 0 }],
...
export function canTurnInQuest(npcName) {
  return questState.active.some((questId) => {
    ...
    // 检查是否需要与此NPC交付
    const hasDeliverObjective = quest.objectives.some(
      (obj) => obj.type === "deliver" && obj.target === npcName
    );
