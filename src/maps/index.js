...
export const AREA_PORTALS = {
  ...
  forest: [{ x: 29, y: 12, targetArea: "village", targetX: 1, targetY: 12, direction: "right" }],
  lake: [{ x: 15, y: 0, targetArea: "village", targetX: 15, targetY: 23, direction: "up" }],
  mine: [{ x: 15, y: 24, targetArea: "village", targetX: 15, targetY: 1, direction: "down" }],
  castle: [{ x: 0, y: 12, targetArea: "village", targetX: 28, targetY: 12, direction: "left" }],
};
