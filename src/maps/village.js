...
import { PLANTS, FENCES, INTERACTABLES, ITEMS, CHARACTERS } from "../sprites";
...
export const VILLAGE_OBJECTS = [
  ...
  { type: "npc", x: 4, y: 4, name: "elder", frame: CHARACTERS.elder.down, dialogue: "elder" },
  {
    ...
    y: 4,
    name: "merchant",
    frame: CHARACTERS.merchant.down,
    dialogue: "merchant",
  },
  {
    type: "npc",
    ...
    y: 15,
    name: "blacksmith",
    frame: CHARACTERS.blacksmith.down,
    dialogue: "blacksmith",
  },
  {
    type: "npc",
    ...
    y: 15,
    name: "innkeeper",
    frame: CHARACTERS.innkeeper.down,
    dialogue: "innkeeper",
  },
  {
    type: "npc",
    ...
    y: 10,
    name: "villager1",
    frame: CHARACTERS.villager1.down,
    dialogue: "villager1",
  },
  {
    type: "npc",
    ...
    y: 10,
    name: "villager2",
    frame: CHARACTERS.villager2.down,
    dialogue: "villager2",
  },
