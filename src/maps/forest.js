...
import { PLANTS, INTERACTABLES, CHARACTERS, ROCKS } from "../sprites";
...
export const FOREST_OBJECTS = [
  ...
  { type: "collectible", x: 7, y: 19, frame: PLANTS.mushrooms.blue, itemType: "mushroom_blue" },
  {
    ...
    x: 23,
    y: 3,
    frame: PLANTS.mushrooms.cluster1,
    itemType: "mushroom_cluster",
  },
  {
    type: "collectible",
    x: 24,
    y: 18,
    frame: PLANTS.mushrooms.cluster2,
    itemType: "mushroom_cluster",
  },
  ...
  // ===== 宝箱 =====
  {
    ...
    y: 8,
    name: "forest_chest1",
    frame: INTERACTABLES.chest.closed,
    gold: 50,
  },
  {
    type: "chest",
    ...
    y: 22,
    name: "forest_chest2",
    frame: INTERACTABLES.chest.locked,
    gold: 150,
    locked: true,
  },
