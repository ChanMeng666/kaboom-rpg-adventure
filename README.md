...
<a href="https://chanmeng666.github.io/kaboom-rpg-adventure/">
  <img src="docs/showcase/hero.webp" alt="Pixel Adventure title screen with crossed-swords logo and Start Game button" width="100%">
</a>

![Demo: launching Pixel Adventure and exploring the village world](docs/showcase/demo.gif)

<details>
<summary>📱 More screenshots</summary>

| Village Exploration (Desktop) | Mobile View |
|---|---|
| <img src="docs/showcase/gameplay-world.png" alt="Village world with player, NPCs, and HP/MP/EXP HUD" width="420"> | <img src="docs/showcase/mobile.webp" alt="Mobile-responsive title screen" width="200"> |
